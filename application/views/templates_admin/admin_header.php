...
<head>
    ...
    <link href="<?= base_url('assets/assets_user/'); ?>/img/apple-touch-icon.png" rel="icon">

    <!-- Custom fonts for this template-->
    <link href="<?= base_url('assets/assets_admin/'); ?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url('assets/assets_admin/'); ?>https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
